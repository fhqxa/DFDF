...
def Init_Setting():
    ...
    model = HiFuse_Small(num_classes=8).to(torch.device("cuda:0"))
    model.load_state_dict(torch.load('/home/dj212/lwc/DFF-DJL/model_weight/best_model-daul_kvasir.pth'))
