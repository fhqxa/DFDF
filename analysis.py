...
def main(args):
    ...
    if "dffv1_small" in args.model_path:
        model = Init_Setting_DFFV1_Small(args.model_path, num_classes=num_classes)
    if "dffv1_tiny" in args.model_path:
        model = Init_Setting_DFFV1_Tiny(args.model_path, num_classes=num_classes)
    if "dffv1_mini" in args.model_path:
        model = Init_Setting_DFFV1_Mini(args.model_path, num_classes=num_classes)
    if "hifuse_small" in args.model_path:
        model = Init_Setting_HiFuse_Small(args.model_path, num_classes=num_classes)

    # model = Init_Setting_ResNet18(args.model_path,num_classes=8)
    # model = Init_Setting_VGG19(args.model_path,num_classes=7)
    # model = Init_Setting_MIXER(args.model_path,num_classes=7)
    # model = Init_Setting_DEIT(args.model_path, num_classes=7)
    # model = Init_Setting_VIT_32(args.model_path, num_classes=7)
    # model = Init_Setting_VIT_16(args.model_path, num_classes=7)
    # model = Init_Setting_CONVNEXT_B(args.model_path, num_classes=7)
    # model = Init_Setting_FOCAL_B(args.model_path, num_classes=7)
    # model = Init_Setting_SWIN_B(args.model_path, num_classes=7)
